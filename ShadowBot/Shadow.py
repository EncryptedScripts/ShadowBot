...
listApp = [
	"CHROMEOS\t2.1.5\tShadow\t11.2.5", 
	"DESKTOPWIN\t5.9.2\tShadow\t11.2.5", 
	"DESKTOPMAC\t5.9.2\tShadow\t11.2.5", 
	"IOSIPAD\t8.12.2\tShadow\t11.2.5", 
	"WIN10\t5.5.5\tShadow\t11.2.5"
]
try:
	for app in listApp:
		try:
